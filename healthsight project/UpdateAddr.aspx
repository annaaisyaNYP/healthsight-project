...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Label ID="lbAddr" runat="server" ForeColor="Red"></asp:Label>
    <table class="nav-justified">
        ...
        <tr>
            ...
            <td style="height: 30px;">
              <asp:Button style="width: 200px;" ID="btnUpdAddr" runat="server" Text="Update Email" OnClick="btnUpdEmail_Click" />
            </td>
        </tr>
    </table>
